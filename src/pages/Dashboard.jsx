    ...
    <div className="dashboard-layout fade-in">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          <a href="#" className="active"><i className='bx bx-grid-alt'></i> Overview</a>
          <a href="#"><i className='bx bx-transfer'></i> Transfers</a>
          <a href="#"><i className='bx bx-credit-card'></i> Cards</a>
          <a href="#"><i className='bx bx-line-chart'></i> Statistics</a>
          <a href="#"><i className='bx bx-cog'></i> Settings</a>
        </nav>
